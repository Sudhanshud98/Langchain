...
class Review(BaseModel):
    key_themes : list[str] = Field(description="The list of key themes disscussed in the review")
    summary : str = Field(description="A brief summary of the review")
    sentiment : Literal["pos", "neg"] = Field(description="The overall sentiment of the review")
